...
\begin{table}[!htb]
\begin{center}
\caption{Sinusoidal Sweeping Vibration Test Condition}\label{tab:sinetest}
\begin{tabular}{cccc}
\hline
\multicolumn{2}{c}{\textbf{Acceptance Test}}                                                                                   & \multicolumn{2}{c}{\textbf{Qualification Test}}                                                                                \\ \hline
\begin{tabular}[c]{@{}c@{}}Frequency Range\\ (Hz)\end{tabular} & \begin{tabular}[c]{@{}c@{}}Vibration\\ Amplitude\end{tabular} & \begin{tabular}[c]{@{}c@{}}Frequency Range\\ (Hz)\end{tabular} & \begin{tabular}[c]{@{}c@{}}Vibration\\ Amplitude\end{tabular} \\
