...
From \cite{larson2005}, 5 \% per year is a usual number for the solar panels degradation, in others words, the general efficiency of the solar panels decays in a rate of 5 \% per year of operation.% Also, \cite{larson2005} defines the battery degradation (or aging )as XX \% per year.
