...
\subsection{Ground Station Passes Analysis}

Considering two ground stations, one at the SpaceLab installations in Florianópolis and other at the INPE/CRN installations in Natal, both with a minimum elevation of 15$^{\circ}$, the following results were achieved during the simulations on GMAT.
