...
\begin{itemize}
    ...
    \item Groundstation antenna gain ($G_{t}$): \textbf{15 dB}
\end{itemize}

\subsubsection{Free-Space Path Loss}

\begin{equation}
FSPL = \left( \frac{4\pi \cdot d \cdot f}{c} \right)^{2}
\end{equation}

\begin{equation}
    FSPL = 20\cdot \log\left(\frac{4\pi}{c}\right) + 20\cdot \log\left(d\right) + 20\cdot \log\left(f\right)\ [dB]
\end{equation}

\begin{equation}
FSPL = 32,45 + 20\cdot \log\left(\frac{d}{1\ km}\right) + 20\cdot \log\left(\frac{f}{1\ MHz}\right)\ [dB]
\end{equation}

\begin{equation}
FSPL_{max} = 32,45 + 20\cdot \log\left(\frac{2830}{1\ km}\right) + 20\cdot \log\left(\frac{145,97}{1\ MHz}\right) = \mathbf{144,8\ dB}
\end{equation}

\begin{equation}
FSPL_{min} = 32,45 + 20\cdot \log\left(\frac{600}{1\ km}\right) + 20\cdot \log\left(\frac{145,97}{1\ MHz}\right) = \mathbf{131,3\ dB}
\end{equation}

\begin{equation}
\mathbf{131,3 \leq L_{p} \leq 144,8\ dB}
\end{equation}
