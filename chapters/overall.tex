...
\begin{landscape}
    \begin{table}[ht]
        ...
        \begin{tabular}{llcccc}
            ...
            \midrule
            \multirow{4}{*}{Beacon}   & EPS Data              & 00h & \multirow{6}{*}{``0'' + ``PY0EGU''} & EPS + TTC data                             & 58           \\
                                      & TTC Data              & 01h &                                     & TTC data                                   & 18           \\
                                      & EPS Data              & 02h &                                     & EPS + TTC data                             & 39           \\
                                      & TTC Data              & 03h &                                     & TTC data                                   & 18           \\
            \midrule
            \multirow{5}{*}{Downlink} & Telemetry             & 10h & \multirow{6}{*}{``0'' + ``PY0EGU''} & Flags + OBDH/EPS data                      & 220          \\
            ...
            \midrule
            \multirow{4}{*}{Uplink}   & Ping Request          & 20h & \multirow{3}{*}{Any Callsign}       & None                                       & 8            \\
