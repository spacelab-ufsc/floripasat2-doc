...
The output power of the radio modules can be measured using a spectrum analyzer. The measured values for the beacon and downlink transmitters are available in Figures \ref{fig:beacon-power} and \ref{fig:downlink-power} respectively.
